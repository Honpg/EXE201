  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-50 to-gray-200 text-gray-800 pt-20">
      <header className="text-center mb-10">
        <h1 className="text-6xl font-bold text-blue-600 mb-4">Welcome to Ocean AI!</h1>
        <p className="text-xl text-gray-900">Your AI-powered meeting companion</p>
      </header>

      <main className="max-w-4xl mx-auto p-4">
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-blue-700 mb-4">What is Ocean AI?</h2>
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-blue-700 mb-4">Key Features</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center p-6 border border-blue-300 rounded-lg shadow-lg bg-white hover:shadow-xl transition-shadow duration-300">
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-semibold text-blue-700 mb-4">Reporting Customizations</h2>
        ...
        <section>
          <h2 className="text-3xl font-semibold text-blue-700 mb-4">Screenshots Included!</h2>
