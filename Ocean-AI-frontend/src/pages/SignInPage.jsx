...
const handleGoogleSignIn = (e) => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-orange-100 via-pink-50 to-purple-100">
      <div className="relative my-4 mx-4">
      <div
    className="absolute -inset-2 rounded-lg bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600 opacity-75 blur"
  ></div>
      <div className="relative p-7 lg:p-10 bg-white shadow-lg rounded-lg p-10 max-w-lg text-center">
        <h1 className="text-4xl font-bold mb-5 logo-bg">Welcome to Ocean AI</h1>
        ...
        <button
          ...
          className="flex items-center justify-center w-full bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600 hover:from-orange-500 hover:via-pink-600 hover:to-purple-700 text-white font-semibold py-2 px-4 rounded-lg shadow transition duration-200"
        >
