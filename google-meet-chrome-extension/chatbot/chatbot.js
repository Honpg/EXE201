...
https://ai.google.dev/gemini-api/docs/rate-limits`;
    ...
    function addInitialGreeting() {
        ...
        setTimeout(() => {
            const greeting = 'Hey there! 👋 I\'m Ocean AI, your friendly meeting assistant. I\'m here to help analyze meetings and chat about anything else too! / Chào bạn! 👋 Mình là Ocean AI, trợ lý họp thông minh và thân thiện. Mình có thể giúp phân tích cuộc họp và trò chuyện về mọi chủ đề khác nữa! 😊';
